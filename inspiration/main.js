	...
	function scrollToSection(sectionFrom, sectionTo){
		...
		if (sectionFrom.index() < sectionTo.index())
		{
			...
			tlDown
				...
				.set(slideContent, {autoAlpha: 0, x: '-30%'})
				.set([slideContentH3, slideContentP, slideContentH4, slideContentButton], {autoAlpha: 0, x: '10px'})

				.to(sectionTo, 1.2, {x: '0%', ease:Power4.easeInOut}, '0')
				.to(slideContent, 1.2, {autoAlpha: 1, x: '0%', ease:Power4.easeInOut}, '0')

				.to(sectionFrom, 1.2, {x: '-=100%', ease:Power4.easeInOut, clearProps: 'all'}, '0')
				.to(slideContentFrom, 1.2, {autoAlpha: 0, x: '30%', ease:Power4.easeInOut}, '0')


				.to(slideContentH3, 0.7, {autoAlpha: 1, x: '0', ease:Power4.easeInOut}, '-=0.5')
				.to(slideContentP, 0.7, {autoAlpha: 1, x: '0', ease:Power4.easeInOut}, '-=0.5')
				.to(slideContentH4, 0.7, {autoAlpha: 1, x: '0', ease:Power4.easeInOut}, '-=0.5')
				.to(slideContentButton, 0.7, {autoAlpha: 1, x: '0', ease:Power4.easeInOut}, '-=0.5')
				.set($body, {className: '-=is-animating'});
